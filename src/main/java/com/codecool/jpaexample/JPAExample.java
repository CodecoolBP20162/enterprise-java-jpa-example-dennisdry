...
public class JPAExample {
    ...
    public static void populateDb(EntityManager em) {
        ...
        ArrayList<String> phoneNumberList1 = new ArrayList();
        phoneNumberList1.add("3213123");
        phoneNumberList1.add("4564564564");

        ArrayList<String> phoneNumberList2 = new ArrayList();
